...
<div id="carouselHeader" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item carousel-item-small active carousel-item-04" style="background-image: linear-gradient(rgba(0, 0, 0, 0.70), rgba(0, 0, 0, 0.20)), url('http://murayamaengenharia.com.br/webroot/img/projects/<?php echo $project['id']; ?>/capa.jpg'); background-position: bottom center">
...
<section class="container" style="margin-top: 70px">
    ...
    <div class="row mt-5 mb-5">
        <div class="col-md-4 col-xs-12 mb-4">
            <a class="" href="http://murayamaengenharia.com.br/webroot/img/projects/<?php echo $project['id']; ?>/capa.jpg" data-lightbox="<?php echo $project['title']; ?>" data-title="<?php echo $project['title']; ?>">
                <img class="" src="http://murayamaengenharia.com.br/webroot/img/projects/<?php echo $project['id']; ?>/capa-thumb.jpg" width="100%" alt="" style="border-radius: 15px">
            </a>
        </div>
        <?php foreach ($project['project_images'] as $image) : ?>
            <div class="col-md-4 col-xs-12 mb-4">
                <a class="" href="http://murayamaengenharia.com.br/webroot/img/projects/<?php echo $project['id']; ?>/<?php echo $image['image']; ?>" data-lightbox="<?php echo $project['title']; ?>" data-title="<?php echo $project['title']; ?>">
                    <img class="" src="http://murayamaengenharia.com.br/webroot/img/projects/<?php echo $project['id']; ?>/<?php echo $image['image']; ?>" width="100%" alt="" style="border-radius: 15px">
                </a>
            </div>
        <?php endforeach;?>
    </div>
