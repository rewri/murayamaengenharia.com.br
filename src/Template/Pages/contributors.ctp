            ...
            <div class="col-md-3 col-xs-12" style="margin-bottom: 50px">
                <div class="card p-3 text-center" style="height: 430px !important;">
                    <div class="card-body p-0 m-0">
                        <div style="background: url('http://murayamaengenharia.com.br/webroot/img/contributors/<?php echo $row['image']; ?>'); background-size: cover; background-position: center top; background-repeat: no-repeat; height: 300px"></div>
