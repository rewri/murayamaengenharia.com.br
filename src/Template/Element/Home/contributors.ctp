                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="card p-3">
                                        <div class="card-body p-0 m-0">
                                            <div style="background: url('//murayamaengenharia.com.br/webroot/img/contributors/<?php echo $row['image']; ?>'); background-size: cover; background-position: center center; background-repeat: no-repeat; height: 300px"></div>
