...
<div class="container-fluid" style="background-color: #f3f3f3; margin-top: 60px; ">
    <div class="container" id="budget" style="padding-bottom: 50px">
        <div class="row" style="font-size: 1.1em">
            ...
            <div class="col-md-6 col-xs-12" style="color: #494c50;">
                ...
                <ul style="list-style: none">
                    <li class="pb-4" style="color: #5a5e63; font-size: 1em"><span class="icon-arrow-right pr-1"></span> Soluções completas no desenvolvimento de projetos que atendam às estratégias de negócio dos clientes.</li>
                    <li class="pb-4" style="color: #5a5e63; font-size: 1em"><span class="icon-arrow-right pr-1"></span> Agilidade no desenvolvimento e formatação de projetos e "sonhos", buscando até mesmo antecipar-se às demandas.</li>
                    <li class="pb-4" style="color: #5a5e63; font-size: 1em"><span class="icon-arrow-right pr-1"></span> Expertise na estruturação de parcerias para o projeto e melhor gerenciamento,  com foco na redução de custos, diminuição de perdas e gerenciamento de tempo.</li>
                </ul>
            ...
            <div class="col-md-6 col-xs-12" id="budget-form-div" style="padding-left: 80px;">
                ...
                <form  autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="form-group mb-4">
                                <button type="submit" class="btn btn-info btn-block text-uppercase" style="background-color: #3c5985; border: 1px solid #636363">Enviar</button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center budget-icon">
                        <span class="fab fa-facebook-square" style="font-size: 3em; color: #3C5A99; display: none"></span>
                        <span class="fab fa-facebook-square" style="font-size: 3em; color: #3c5985"></span>
                        <p style="font-size: .9em" class="pt-1">/murayamaengenharia</p>
                    </div>
                    <div class="col-md-4 text-center budget-icon">
                        <span class="fab fa-instagram" style="font-size: 3em; color: #9b6954;; display: none"></span>
                        <span class="fab fa-instagram" style="font-size: 3em; color: #3c5985;"></span>
                        <p style="font-size: .9em" class="pt-1">@murayamaengenharia</p>
                    </div>
                    <div class="col-md-4 text-center budget-icon">
                        <span class="fab fa-whatsapp-square" style="font-size: 3em; color: #128C7E;; display: none"></span>
                        <span class="fab fa-whatsapp-square" style="font-size: 3em; color: #3c5985;"></span>
