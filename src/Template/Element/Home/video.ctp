    <section class="container-fluid" style="margin-top: 80px; background-color: #3C5985">
        <div class="container text-white">
            <div class="row">
                <div class="col-md-5 col-xs-12" style="padding-top: 45px">
                    ...
                    <?php echo $this->Html->link('
                        <button type="button" class="btn btn-outline-secondary text-uppercase btn-more mt-2" style="border: 1px solid #fff; color: #fff">
                            Conheça mais
                        </button>
                        ', array(
                        'controller' => 'Pages',
